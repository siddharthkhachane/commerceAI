    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .authorizeHttpRequests {
                ...
                it.requestMatchers(HttpMethod.POST, "/api/assistant/compare").permitAll()
                it.requestMatchers(HttpMethod.POST, "/api/assistant/chat").permitAll()
                it.requestMatchers(HttpMethod.GET, "/api/assistant/conversations/*").permitAll()
                it.requestMatchers(HttpMethod.GET, "/api/recommendations/similar/**", "/api/recommendations/related").permitAll()
